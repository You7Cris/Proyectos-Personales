...
# Iniciacilar a pygame
pygame.init()

pantalla = pygame.display.set_mode((800, 600)) # Crear y poner Tamño de la pantalla

# Cambiar Titulo y color de fondo
pygame.display.set_caption("Invasión espacial")

icono = pygame.image.load("nave_espacial.png")
...
img_jugador = pygame.image.load("cohete_espacial.png")
jugador_x = 368
jugador_y = 500
jugador_x_cambio = 0
...
while se_ejecuta:
    ...
    #RGB
    #pantalla.fill((205, 144, 228)) #Relleno
